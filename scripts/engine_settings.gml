...
// Enable dev keys
// this is to ensure that when you start the game you have debug keys at all times
// (if you want to disable debug keys for the final version you must change it to false).
global.debug_default = false;
