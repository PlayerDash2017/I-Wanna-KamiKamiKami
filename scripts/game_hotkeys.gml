...
if !global.paused {
    ...
    //change player skin
    if keyboard_check_pressed(ord('1')) {//The Kid
        config_set("player_skin",0);
        sound_play8("block_change");
        config_write();
    }
    else if keyboard_check_pressed(ord('2')) {//Kamilia
        config_set("player_skin",1);
        sound_play8("block_change");
        config_write();
    }
    else if keyboard_check_pressed(ord('3')) {//Spike Kid
        config_set("player_skin",2);
        sound_play8("block_change");
        config_write();
    }
    else if keyboard_check_pressed(ord('4')) {//Tomodati
        config_set("player_skin",3);
        sound_play8("block_change");
        config_write();
    }
    else if keyboard_check_pressed(ord('5')) {//Marisa
        config_set("player_skin",4);
        sound_play8("block_change");
        config_write();
    }
    else if keyboard_check_pressed(ord('6')) {//Blue Stick Guy
        config_set("player_skin",5);
        sound_play8("block_change");
        sound_play("gamblecore");
        config_write();
    }
    else if keyboard_check_pressed(ord('7')) && config_get("reimu_unlock") {//Reimu
        config_set("player_skin",6);
        sound_play8("block_change");
        config_write();
    }
}
