...
*/
/// Draw debug overlay
var _text, _player_x, _player_y, _player_align, xFPS;
...
if fps < 49 {
    ...
    xFPS = 16;
    if instance_exists(Player) {
        if Player.x < view_xview[0]+400 {
            draw_set_halign(fa_right);
            xFPS = 800 - 16;
        }
    }
    draw_text_outlined(xFPS, 608 - 16, "FPS: "+string(fps), merge_color(c_red,c_white,fps/50), c_black);
}
